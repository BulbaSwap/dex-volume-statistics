import { MEME_TOKENS, V1_TOKENS, V2_TOKENS, V3_TOKENS } from './tokens'
...
export const V3_POOLS = {
  ...
  '0x21e66adc475cd2f59723eb35b34d93a8355741fd': {
    token0: V3_TOKENS.WETH,
    token1: V3_TOKENS.USDT
  },
  // WETH/USDT 0.3%
