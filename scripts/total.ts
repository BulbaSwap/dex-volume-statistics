...
const calcV1Total = () => {
  ...
  const v1SwapArr = parseFile(v1SwapPath, { headers: ['Address', 'Count'] })
  const v1LiquidityArr = parseFile(v1LiquidityPath, { headers: ['Address', 'Count'] })
...
const calcV2Total = () => {
  ...
  const v2SwapArr = parseFile(v2SwapPath, { headers: ['Address', 'Count'] })
  const v2LiquidityArr = parseFile(v2LiquidityPath, { headers: ['Address', 'Count'] })
...
const calcV3Total = () => {
  ...
  const v3SwapArr = parseFile(v3SwapPath, { headers: ['Address', 'Count'] })
  const v3LiquidityArr = parseFile(v3LiquidityPath, { headers: ['Address', 'Count'] })
